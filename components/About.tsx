...
import { IconEmail, IconPhone, IconLinkedIn, IconGitHub, IconGlobe, IconCalendar } from "./Icons";
...
const INFO = [
  ...
  { icon: <IconCalendar size={16} />, label: "Date of Birth", val: "18 May 2005" },
];

const TAGS = [
  "Quality Control & Assurance","Sensory Evaluation","New Product Development",
  "AI-Assisted Development","Full-Stack Platforms","Event Coordination",
...
const TECH_TRAITS = [
  "AI-directed architecture & coding","Poudyal Farms — 20+ API endpoints",
  "Saravana Caters — catering ERP","Claude Opus, ChatGPT, Antigravity",
        ...
        <div className={styles.topGrid}>
          <div>
            ...
            <div className={styles.text}>
              ...
              <p>I direct Claude, ChatGPT, and Google Antigravity from architecture through full implementation — managing requirements, reviewing security and SEO, and iterating to production-ready results.</p>
        ...
        <div className={`${styles.twoWorlds} fade-up`}>
          ...
          <div className={styles.worlds}>
            <div className={styles.worldTeal}>
              ...
              <h3 className={styles.worldTitle}>Food Scientist</h3>
            ...
            <div className={styles.worldGold}>
              ...
              <ul className={styles.worldList} style={{ borderLeftColor: "rgba(240,165,0,0.15)" }}>
