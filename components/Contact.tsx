        ...
        <div className={styles.grid}>
          <div>
            ...
            <p className="section-desc" style={{ marginBottom: "2rem" }}>
              Whether it&apos;s a food tech opportunity, a project collaboration, or just a conversation — I&apos;m always open to it.
            </p>
          ...
          <div className={styles.cta}>
            <h3 className={styles.ctaTitle}>Open to<br /><em>Opportunities</em></h3>
            <p className={styles.ctaDesc}>
              Actively seeking internships, industry projects, and collaborations in food technology — QA/QC, sensory science, NPD, and nutrition research. Also available for AI-assisted software project consultations.
            </p>
